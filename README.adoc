...
Lastly, there is a `bin/show` script which displays the default styles for quick visual convenience. This is the same script that was used to generate the screenshot shown at the top of this document.
